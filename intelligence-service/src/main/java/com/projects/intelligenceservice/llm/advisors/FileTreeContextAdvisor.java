package com.projects.intelligenceservice.llm.advisors;
...
public class FileTreeContextAdvisor implements StreamAdvisor {
    ...
    public Flux<ChatClientResponse> adviseStream(ChatClientRequest request, StreamAdvisorChain streamAdvisorChain) {
        ...
        var projectId = Long.parseLong(context.getOrDefault("projectId", 0).toString());

        var augmentedChatClientRequest = augmentRequestWithFileTree(request, projectId) ;
